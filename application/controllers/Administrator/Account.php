...
class Account extends CI_Controller
{
    ...
    public function cashTransactionInvoice($id)
    {
        $data['title'] = "Cash Transaction Invoice";
        $data['transId'] = $id;
        $data['content'] = $this->load->view('Administrator/account/cash_trans_invoice', $data, TRUE);
        $this->load->view('Administrator/index', $data);
    }
    ...
    public function getCashTransactions()
    {
        ...
        if (isset($data->transSLNo) && $data->transSLNo != '') {
            $dateClause = " and ct.Tr_SlNo = '$data->transSLNo'";
        }
