...
<div class="row">
    <div class="col-md-8 col-md-offset-2">
        <a id="printIcon" style="cursor:pointer">
            <i class="fa fa-print" style="font-size:24px;color:green"></i> Print</a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
        <a href="<?php echo base_url(); ?>customerPaymentPage" title="" class="buttonAshiqe">Go Back</a>
        <div id="reportContent">
            <div class="row" style="margin-bottom: 20px;">
                <div class="col-xs-12">
                    <h6 style="background:#ddd; text-align: center; font-size: 18px; font-weight: 900; padding: 5px; color: #bd4700;">Renter Payment Invoice</h6>
                </div>
            </div>
            <div class="row" style="margin-bottom: 20px;">
                <div class="col-xs-12">
                    ...
                    <table class="border" cellspacing="0" cellpadding="0" style="width: 100%;">
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td style="text-align:right;"><?php if ($type == 'CR') : echo number_format($CPROW->CPayment_amount, 2);
                                                                else : echo '00.00';
                                                                endif; ?></td>
                                <td style="text-align:right;"><?php if ($type == 'CP') : echo number_format($CPROW->CPayment_amount, 2);
                                                                else : echo '00.00';
                                                                endif; ?></td>
                            </tr>
                            <tr>
                                <th colspan="2" style="font-size: 14px; font-weight: 700; text-align: right;">Total:</th>
                                <th style="font-size: 13px; font-weight: 700;text-align:right;"><?php if ($type == 'CR') : echo number_format($CPROW->CPayment_amount, 2);
                                                                                                else : echo '00.00';
                                                                                                endif; ?></th>
                                <th style="font-size: 13px; font-weight: 700;text-align:right;"><?php if ($type == 'CP') : echo number_format($CPROW->CPayment_amount, 2);
                                                                                                else : echo '00.00';
                                                                                                endif; ?></th>
                            </tr>
                        </tbody>
...
<script>
    ...
    async function print() {
        ...
        reportWindow.document.write(`
            <?php $this->load->view('Administrator/reports/reportHeader_cp.php'); ?>
        `);
