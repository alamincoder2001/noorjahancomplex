			...
			<table class="table table-bordered">
				...
				<tbody>
					...
					<tr v-for="payment in payments">
						...
						<td style="text-align:right;">{{ parseFloat(payment.advance).toFixed(2) }}</td>
						<td style="text-align:right;">{{ parseFloat(payment.adjust).toFixed(2) }}</td>
	...
	new Vue({
		...
		methods:{
			...
			getReport(){
				...
				axios.post('/get_advance_payment_report', data).then(res => {
			...
			async print(){
				let reportContent = `
					<div class="container">
						<h4 style="text-align:center">Renter Advance payment report</h4 style="text-align:center">
						<div class="row">
							<div class="col-xs-6" style="font-size:12px;">
								<strong>Renter ID: </strong> ${this.selectedCustomer.Customer_Code}<br>
