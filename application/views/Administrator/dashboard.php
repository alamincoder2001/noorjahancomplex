	...
	<div class="row">
		<div class="col-md-12 col-xs-12">
			...
			<div class="col-md-12 header" style="height: 130px;">
				<img style="padding: 0px 10px; border: 1px solid #e1e1ff;" src="<?php echo base_url(); ?>assets/images/linkup_logo.png" class="img img-responsive center-block">
			</div>
			<div class="col-md-10 col-md-offset-1">
				...
				<!-- module/RentModule -->
				<div class="col-md-3 section4">
					<div class="col-md-12 section122" style="background: rgb(210, 210, 255);" onmouseover="this.style.background = '#d2d2ff'" onmouseout="this.style.background = '#e1e1ff'">
	...
	<div class="row">
		<div class="col-md-12 col-xs-12">
			...
			<div class="col-md-10">
				...
				<?php endif; ?>
				<!--<?php if (array_search("", $access) > -1 || isset($CheckSuperAdmin) || isset($CheckAdmin)) : ?>-->
				<!--	<div class="col-md-2 ">-->
				<!--		<div class="col-md-12 section20">-->
