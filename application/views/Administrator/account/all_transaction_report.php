                        ...
                        <tr v-for="transaction in transactions">
                            ...
                            <td>
                                <?php if ($this->session->userdata('accountType') != 'u') { ?>
                                    <a href="" title="Invoice" v-bind:href="`/cashTransactionInvoice/${transaction.Tr_SlNo}`" target="_blank"><i class="fa fa-file"></i></a>
                                    <!-- <a href="" title="Edit" @click.prevent="editTransaction(transaction)"><i class="fa fa-edit"></i></a> -->
                                    <a href="" title="Delete" @click.prevent="deleteTransaction(transaction.Tr_SlNo)"><i class="fa fa-trash"></i></a>
                                <?php } ?>
                            </td>
                        </tr>
                    </tbody>
