...
<div id="rentsInvoiceReport" class="row">
  ...
  <div class="col-md-8 col-md-offset-2">
    <br>
    <sales-invoice v-bind:sales_id="selectedInvoice.id" v-if="showInvoice"></sales-invoice>
  </div>
</div>
...
<script>
  ...
  new Vue({
    ...
    methods: {
      async getSales() {
        await axios.get("/get_rents").then(res => {
          this.invoices = res.data.rents;
        })
      },
      async viewInvoice() {
