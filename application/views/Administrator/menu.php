...
?>
	<ul class="nav nav-list">
		...
		<li class="">
			<a href="<?php echo base_url(); ?>module/RentModule">
				<i class="menu-icon fa fa-money"></i>
				<span class="menu-text"> Rent Module </span>
			</a>
			<b class="arrow"></b>
		</li>
...
<?php } elseif ($module == 'SalesModule') { ?>
	<ul class="nav nav-list">
		...
		<?php if (
			...
			// || array_search("CostCenterReport", $access) > -1
			...
			<li class="">
				...
				<ul class="submenu">
					...
					<!-- <?php if (array_search("CostCenterReport", $access) > -1 || isset($CheckSuperAdmin) || isset($CheckAdmin)) : ?>
						<li class="">
							<a href="<?php echo base_url(); ?>CostCenterReport">
								<i class="menu-icon fa fa-caret-right"></i>
								Cost Center Report
							</a>
							<b class="arrow"></b>
...
<?php } elseif ($module == 'RentModule') { ?>
	<ul class="nav nav-list">
		...
		<li>
			<a href="<?php echo base_url(); ?>module/RentModule" class="module_title">
				<span>Rent Module</span>
			</a>
		</li>

		<?php if (array_search("rent_generate", $access) > -1 || isset($CheckSuperAdmin) || isset($CheckAdmin)) : ?>
			<li class="">
				<a href="<?php echo base_url(); ?>rent_generate">
					<i class="menu-icon fa fa-money"></i>
					<span class="menu-text">Rent Generate </span>
				</a>
				<b class="arrow"></b>
			</li>
		<?php endif; ?>
		...
		<?php if (array_search("customer", $access) > -1 || isset($CheckSuperAdmin) || isset($CheckAdmin)) : ?>
			<li class="">
				<a href="<?php echo base_url(); ?>customer">
					<i class="menu-icon fa fa-users"></i>
					<span class="menu-text"> Renter Entry </span>
				</a>
				<b class="arrow"></b>
			</li>
		<?php endif; ?>
		...
		<?php endif; ?>
		<?php if (array_search("shop_entry", $access) > -1 || isset($CheckSuperAdmin) || isset($CheckAdmin)) : ?>
			<li class="">
				<a href="<?php echo base_url(); ?>shop_entry">
					<i class="menu-icon fa fa-briefcase"></i>
					<span class="menu-text"> Flat / Shop Entry </span>
				</a>
				<b class="arrow"></b>
			</li>
		<?php endif; ?>

		<?php if (array_search("add_electricity_bill", $access) > -1 || isset($CheckSuperAdmin) || isset($CheckAdmin)) : ?>
			<li class="">
				<a href="<?php echo base_url(); ?>add_electricity_bill">
					<i class="menu-icon fa fa-plug"></i>
					<span class="menu-text"> Electricity Bill Entry </span>
				</a>
				<b class="arrow"></b>
			</li>
		<?php endif; ?>
		...
		<?php if (
			...
			<li class="">
				...
				<ul class="submenu">
					...
					<?php if (array_search("rent_report", $access) > -1 || isset($CheckSuperAdmin) || isset($CheckAdmin)) : ?>
						<li class="">
							<a href="<?php echo base_url(); ?>rent_report">
								<i class="menu-icon fa fa-caret-right"></i>
								Rent Generate Report
							</a>
							<b class="arrow"></b>
						</li>
					<?php endif; ?>

					<?php if (array_search("rent_generate_list", $access) > -1 || isset($CheckSuperAdmin) || isset($CheckAdmin)) : ?>
						<li class="">
							<a href="<?php echo base_url(); ?>rent_generate_list">
								<i class="menu-icon fa fa-caret-right"></i>
								Rent Generate List
							</a>
							<b class="arrow"></b>
					...
					<?php if (array_search("advance_report", $access) > -1 || isset($CheckSuperAdmin) || isset($CheckAdmin)) : ?>
						<li class="">
							<a href="<?php echo base_url(); ?>advance_report">
								<i class="menu-icon fa fa-caret-right"></i>
								Advance Report
							</a>
							<b class="arrow"></b>
					...
					<?php endif; ?>
					<?php if (array_search("advance_payment_report", $access) > -1 || isset($CheckSuperAdmin) || isset($CheckAdmin)) : ?>
						<li class="">
							<a href="<?php echo base_url(); ?>advance_payment_report">
								<i class="menu-icon fa fa-caret-right"></i>
					...
					<?php endif; ?>
					<?php if (array_search("cost_center_column_wise", $access) > -1 || isset($CheckSuperAdmin) || isset($CheckAdmin)) : ?>
						<li class="">
							<a href="<?php echo base_url(); ?>cost_center_column_wise">
								<i class="menu-icon fa fa-caret-right"></i>
								Cost Center Column Wise
							</a>
							<b class="arrow"></b>
						</li>
					<?php endif; ?>
					...
					<?php if (array_search("electricity_bill_report", $access) > -1 || isset($CheckSuperAdmin) || isset($CheckAdmin)) : ?>
						<li class="">
							<a href="<?php echo base_url(); ?>electricity_bill_report">
								<i class="menu-icon fa fa-caret-right"></i>
		...
		<?php if (array_search("customerPaymentPage", $access) > -1 || isset($CheckSuperAdmin) || isset($CheckAdmin)) : ?>
			<li class="">
				<a href="<?php echo base_url(); ?>customerPaymentPage">
					<i class="menu-icon fa fa-money"></i>
					<span class="menu-text"> Renter Payment </span>
				</a>
				<b class="arrow"></b>
			</li>
		<?php endif; ?>

		<?php if (array_search("shopSalePage", $access) > -1 || isset($CheckSuperAdmin) || isset($CheckAdmin)) : ?>
			<li class="">
				<a href="<?php echo base_url(); ?>shopSalePage">
					<i class="menu-icon fa fa-money"></i>
					<span class="menu-text"> Shop Sale </span>
				</a>
				<b class="arrow"></b>
			</li>
		<?php endif; ?>
	...
	<ul class="nav nav-list">
		...
		<?php if (
			...
			<li class="">
				<a href="<?php echo base_url(); ?>" class="dropdown-toggle">
					<i class="menu-icon fa fa-file"></i>
					<span class="menu-text"> Rents Report </span>
					<b class="arrow fa fa-angle-down"></b>
				</a>
