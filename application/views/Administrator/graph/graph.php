...
<div id="graph">
    ...
    <div class="row" v-if="showData" style="display:none;" v-bind:style="{ display: showData ? '' : 'none' }">
        <div class="col-md-2">
            <div class="widgets" style="border-top: 5px solid #1c8dff;">
                ...
                <div class="widget-content">
                    <div class="widget-text">Today's Rents</div>
        ...
        <div class="col-md-2">
            <div class="widgets" style="border-top: 5px solid #008241;">
                ...
                <div class="widget-content">
                    <div class="widget-text">Monthly Rent</div>
    ...
    <div class="row" style="margin-top:20px;margin-bottom: 25px;">
        ...
        <div class="col-md-12" v-if="salesGraph == 'monthly'">
            <h3 class="text-center">This Month's Rent</h3>
            <sales-chart
            type="ColumnChart"
            :data="salesData"
        ...
        <div class="col-md-12" v-else>
            <h3 class="text-center">This Year's Rent</h3>
            <sales-chart
            type="ColumnChart"
    ...
    <div class="row">
        ...
        <div class="col-md-6">
            <h3 class="text-center">Top Renters</h3>
            <top-customer-chart
            type="PieChart"
            :data="topCustomers"
        ...
        data () {
            return {
                ...
                salesChartOptions: {
                    chart: {
                        title: 'Rents',
                        subtitle: "This month's rents data",
                    }
                },
                yearlySalesData: [
                    ['Month', 'Rents']
                ...
                yearlySalesChartOptions: {
                    chart: {
                        title: 'Rents',
                        subtitle: "This year's rents data",
                    }
                },
                topProducts: [
                    ['Product', 'Quantity']
