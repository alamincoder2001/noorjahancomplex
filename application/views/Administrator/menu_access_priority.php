...
<div id="userAccess">
    ...
    <div class="row" id="accessRow">
        <div class="col-md-3">
            <div class="group">
                <input type="checkbox" id="rents" class="group-head" @click="onClickGroupHeads"> <strong>Rents</strong>
                <ul ref="rents">
                    <li><input type="checkbox" class="access" value="customer" v-model="access"> Renter Entry</li>
                    <li><input type="checkbox" class="access" value="customerlist" v-model="access"> Renter List</li>
                    <li><input type="checkbox" class="access" value="shop_entry" v-model="access"> Office/Shop Entry</li>
                    <li><input type="checkbox" class="access" value="rent_generate" v-model="access"> Rent Generate</li>
                    <li><input type="checkbox" class="access" value="add_electricity_bill" v-model="access"> Electricity Bill Entry</li>
            ...
            <div class="group">
                ...
                <ul ref="accounts">
                    ...
                    <li><input type="checkbox" class="access" value="customerPaymentPage" v-model="access"> Renter Payment</li>
                    <li><input type="checkbox" class="access" value="CostCenterReport" v-model="access"> Cost Center Report</li>
                    <li><input type="checkbox" class="access" value="cost_center_column_wise" v-model="access"> Cost Center Column Wise</li>
        ...
        <div class="col-md-3">
            <div class="group">
                <input type="checkbox" id="salesReports" class="group-head" @click="onClickGroupHeads"> <strong>Rents Reports</strong>
                <ul ref="salesReports">
                    <li><input type="checkbox" class="access" value="salesinvoice" v-model="access"> Rent Invoice</li>
                    <li><input type="checkbox" class="access" value="rent_report" v-model="access"> Rent Generate Report</li>
                    <li><input type="checkbox" class="access" value="rent_generate_list" v-model="access"> Rent Generate List</li>
                    <li><input type="checkbox" class="access" value="advance_report" v-model="access"> Advance Report</li>
                    <li><input type="checkbox" class="access" value="advance_payment_report" v-model="access"> Advance Payment Report</li>
                    <li><input type="checkbox" class="access" value="customerPaymentReport" v-model="access"> Renter Payment Report</li>
                    <li><input type="checkbox" class="access" value="customer_payment_history" v-model="access"> Renter Payment History</li>
                    <li><input type="checkbox" class="access" value="customerDue" v-model="access"> Renter Due List</li>
                    <li><input type="checkbox" class="access" value="electricity_bill_report" v-model="access"> Electricity Bill Reports</li>
