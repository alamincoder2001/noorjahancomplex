...
$route['cost_center_column_wise'] = 'Administrator/Customer/CostCenterColumnWise';
$route['get_cost_center_column_wise'] = 'Administrator/Customer/getCostCenterColumnWise';
...
$route['shopSalePage'] = 'Administrator/Customer/shopSalePage';
$route['add_shop_sale'] = 'Administrator/Customer/addShopSale';
$route['update_shop_sale'] = 'Administrator/Customer/updateShopSale';
$route['delete_shop_sale'] = 'Administrator/Customer/deleteSalePage';
$route['get_shop_sale'] = 'Administrator/Customer/getSalePage';
$route['get_shop_sale_customers'] = 'Administrator/Customer/getShopSaleCustomers';
$route['get_customer_due_shop_sale'] = 'Administrator/Customer/getCustomerDueShopSale';
...
$route['CostCenterReport'] = 'Administrator/Customer/Cost_Center_Report';
...
$route['cashTransactionInvoice/(:any)'] = 'Administrator/Account/cashTransactionInvoice/$1';
...
$route['send_sms_day_book'] = 'Administrator/Rent/sendSmsDayBook';
...
// *** new route add by Azharul islam (25-10-2021) ***

// Shop Route
$route['shop_entry'] = 'Administrator/Shop/ShopEntry';
$route['get_shop'] = 'Administrator/Shop/getShop';
$route['save_shop'] = 'Administrator/Shop/SaveShop';
$route['update_shop'] = 'Administrator/Shop/shopUpdate';
$route['delete_shop'] = 'Administrator/Shop/DeleteShop';
$route['floor_entry'] = 'Administrator/Shop/Floor';
$route['get_floor'] = 'Administrator/Shop/getFloor';
$route['save_floor'] = 'Administrator/Shop/saveFloor';
$route['update_floor'] = 'Administrator/Shop/updateFloor';
$route['delete_floor'] = 'Administrator/Shop/deleteFloor';

// Rent Route 
$route['rent_generate'] = 'Administrator/Rent/rentGenerate';
$route['get_shop_for_rent_generate'] = 'Administrator/Rent/getShopForRentGenerate';
$route['save_generate_rent'] = 'Administrator/Rent/SaveGenerateRent';
$route['update_generate_rent'] = 'Administrator/Rent/UpdateGenerateRent';
$route['check_generate_month'] = 'Administrator/Rent/CheckGenerateMonth';
$route['get_generate_month_rent/(:any)'] = 'Administrator/Rent/getGenerateMonthRent/$1';
$route['rent_generate_list'] = 'Administrator/Rent/RentGenerateList';
$route['get_rent_generate_list'] = 'Administrator/Rent/getRentGenerateList';
$route['get_each_month_rent_list/(:any)'] = 'Administrator/Rent/GetEachMonthRentList/$1';
$route['rent_report'] = 'Administrator/Rent/rentReport';
$route['get_rent_report'] = 'Administrator/Rent/getRentReport';
$route['get_rents_invoice'] = 'Administrator/Rent/getRentsInvoices';
$route['get_invoice_due'] = 'Administrator/Rent/getInvoiceDue';
// $route['get_adjustment_due'] = 'Administrator/Rent/getAdjustmentDue';
$route['advance_report'] = 'Administrator/Rent/AdvanceReport';
$route['advance_payment_report'] = 'Administrator/Rent/AdvancePaymentReport';
$route['get_renter_advance'] = 'Administrator/Rent/getRenterAdvance';
$route['get_advance_payment_report'] = 'Administrator/Rent/getAdvancePayment';

// rent invoice
$route['get_rents'] = 'Administrator/Rent/getRents';

// sendSMS to renter
$route['send_sms_to_renter'] = 'Administrator/Rent/send_sms_to_renter';

// electricity bill
$route['add_electricity_bill'] = 'Administrator/Electricity/index';
$route['get_electricity_bill'] = 'Administrator/Electricity/getElectricityBill';
$route['save_electricity_bill'] = 'Administrator/Electricity/saveElectricityBill';
$route['update_electricity_bill'] = 'Administrator/Electricity/updateElectricityBill';
$route['delete_electricity_bill'] = 'Administrator/Electricity/deleteElectricityBill';
$route['electricity_bill_invoice/(:any)'] = 'Administrator/Electricity/getElectricityInvoice/$1';
$route['electricity_bill_report'] = 'Administrator/Electricity/ElectricityBillReport';
$route['get_previous_unit'] = 'Administrator/Electricity/getPreviousUnit';
